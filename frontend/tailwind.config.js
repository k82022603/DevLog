  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, hsla(270,70%,60%,0.3) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(220,70%,60%,0.3) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(280,70%,60%,0.3) 0px, transparent 50%)',
      },
      boxShadow: {
